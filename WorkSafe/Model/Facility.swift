...
final class Facility:NSManagedObject{
    ...
    @NSManaged  var userDefinedName:String
    ...
    public static func insert(into context: NSManagedObjectContext,department:String, photoURL:String?, roomNumber:String, plant:Int16=5,floor:Int16,userDefinedName:String="") -> Facility {
        ...
        fac.userDefinedName=userDefinedName
        return fac
    }
}
